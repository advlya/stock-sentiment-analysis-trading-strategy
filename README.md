...
Author: Student Project for Spotify AI Mentorship Course
...
Lower the threshold to 0.05 or 0.0 to generate more signals
Add technical indicators (RSI, Bollinger Bands, MACD)
Include more stocks (Microsoft, Google, Amazon)
Medium-term

Collect historical news for each trading day
Implement machine learning (Random Forest, Neural Networks)
Use advanced NLP models (BERT, FinBERT for financial sentiment)
Add risk management (stop-loss, position sizing)
Long-term

Real-time trading system with live news feeds
Multi-factor analysis combining sentiment, technicals, and fundamentals
